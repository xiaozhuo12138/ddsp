      ...
      for batch_idx in range(1, num_batches + 1):
        try:
          ...
          if mode == 'eval' and batch_idx == 1:
            ...
            f0_crepe_metrics = metrics.LoudnessMetrics(
                sample_rate=sample_rate, frame_rate=frame_rate)
            f0_encoder_metrics = metrics.LoudnessMetrics(
                sample_rate=sample_rate, frame_rate=frame_rate)
          ...
          if mode == 'sample':
            ...
            if has_f0:
              ...
              f0_encoder_metrics.update_state(batch, outputs['f0_hz'])
